...
console.log(`My car color is ${color}. It is a ${year}, ${make} ${model}`)
...
//Code Here
const phone1 = new Phone('iPhone', 11, 200, 'blue', 400)
const phone2 = new Phone('Samsung', "Galaxy", 400, 'white', 700)
const phone3 = new Phone('iPhone', 12, 300, 'red', 600)
